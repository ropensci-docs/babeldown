...
([`babeldown::deepl_translate_markdown_string()`](https://docs.ropensci.org/babeldown/reference/deepl_translate_markdown_string.md))
and Markdown files
([`babeldown::deepl_translate()`](https://docs.ropensci.org/babeldown/reference/deepl_translate.md))
in general; Quarto book chapters
([`babeldown::deepl_translate_quarto()`](https://docs.ropensci.org/babeldown/reference/deepl_translate_quarto.md))
and Hugo blog posts
([`babeldown::deepl_translate_hugo()`](https://docs.ropensci.org/babeldown/reference/deepl_translate_hugo.md))
in particular.

With babeldown you can also *update* translations, see
[`babeldown::deepl_update()`](https://docs.ropensci.org/babeldown/reference/deepl_update.md).
...
[`deepl_usage()`](https://docs.ropensci.org/babeldown/reference/deepl_usage.md)
(or the online DeepL API interface) to get your usage data.
